...
const spirale = 3
const dotSize = 0.01;//slider.sliderDotSize();//sliderDotSize.value(); //größe der punkte wird hier Definiert / wird beeinflusst durch den Slider über "sliderA.value()"
...
function draw() {
  ...
  // Kreise
    ...
    const r = sig * f * sliderDotSize.value();  // vorher war     const r = sig * f * dotSize;
